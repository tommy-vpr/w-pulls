      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pt-20">
        ...
        <div className="flex flex-col gap-4 mb-8">
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="h-11 flex-1 max-w-md bg-zinc-800 rounded-lg animate-pulse" />
            <div className="flex gap-2">
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="h-10 w-20 bg-zinc-800 rounded-lg animate-pulse"
                />
              ))}
            </div>
          </div>
          <div>
            ...
            <div className="flex gap-2">
              {[1, 2, 3, 4, 5].map((i) => (
                <div
                  key={i}
                  className="h-9 w-16 bg-zinc-800 rounded-lg animate-pulse"
                />
              ))}
            </div>
          </div>
