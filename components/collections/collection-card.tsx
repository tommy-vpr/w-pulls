...
export function CollectionCard({ item, onQuickView }: CollectionCardProps) {
  ...
  return (
    <div className="group rounded-lg overflow-hidden border border-zinc-800 bg-zinc-900/60 transition-all hover:border-zinc-700 hover:bg-zinc-800/50 hover:shadow-lg hover:shadow-black/20">
      ...
      <div className="p-3">
        ...
        <p className="text-sm text-emerald-400">${item.value.toFixed(2)}</p>
      </div>
    </div>
  );
}
